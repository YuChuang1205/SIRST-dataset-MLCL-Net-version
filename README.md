...
#### It is worth noting that we infer from the public ALCNet code that the division of training samples and test samples is exactly the same as that of ALCNet. The only difference is that we modified the name of the images to facilitate reading the corresponding image and mask during network training.
