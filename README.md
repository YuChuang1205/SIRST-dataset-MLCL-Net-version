...
#### We unified the data set for easy and rigorous experimental comparison. The test set is allocated to 96 samples, which correspond to the 96 test result images in the ALCNet code (one-to-one correspondence). The uniform size of the images input to the network is 512 × 512 pixels.   
