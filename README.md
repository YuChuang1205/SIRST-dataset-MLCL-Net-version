# SIRST-dataset-MLCL-Net-version
...
#### We unified the data set for easy and rigorous experimental comparison. The test set is allocated to 96 samples, which corresponds to the test images of ALCNet demo [[link](https://github.com/YimianDai/open-alcnet/tree/master/results/pred)]. The uniform size of the images input to the network is 512 × 512 pixels.   
